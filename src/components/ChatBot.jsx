...
const knowledge = [
  ...
  { keywords: ['students', 'students hub', 'student hub', 'study', 'formula', 'periodic table', 'graph plotter', 'math', 'physics', 'chemistry'], response: '**Students Hub** has 6 powerful study tools:\n📐 **Formula Hub** — 140+ formulas for Math, Physics & Chemistry (Class 6–12)\n⚛️ **Periodic Table** — Interactive 118-element table with detailed properties\n📈 **Graph Plotter** — Plot y=f(x) with pan, zoom & presets\n🔌 **Logic Gate Simulator** — Build digital circuits with drag & drop\n📊 **SFD & BMD Generator** — Shear force & bending moment diagrams\n🔧 **ECE/EEE Tool Suite** — 7 electronics tools (resistor codes, 555 timer, signal plotter, op-amp, filters)', link: { text: 'Explore Students Hub →', to: '/students-hub' } },
...
const suggestions = ['What tools do you have?', 'Show me games', 'Tell me about FreeForge', 'Resume builder', 'Students Hub', 'ECE/EEE tools'];
