...
const SECTIONS = [
  {
    ...
    items: [
      ...
      { icon: '🐶', name: 'Animal Sound Quiz', desc: 'Identify animal sounds' },
      ...
      { icon: '🍎', name: 'Fruit & Vegetable Names', desc: 'Match produce to their names' },
      { icon: '🚗', name: 'Vehicle Identification', desc: 'Identify different vehicles' },
      { icon: '🧠', name: 'Memory Card Game', desc: 'Find matching card pairs' },
    ...
    subs: [
      {
        ...
        items: [
          ...
          { icon: '🧩', name: 'Sudoku for Kids', desc: 'Simple 4x4 sudoku puzzles' },
        ],
      },
      {
        sub: 'Science',
