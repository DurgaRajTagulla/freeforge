...
export default function KidsActivityPage() {
  ...
  const renderContent = () => {
    ...
    case 'country-flags': {
      ...
      const qs = [
        { question: 'Which country is this? 🇮🇳', options: ['India', 'China', 'Japan', 'Nepal'], correctIndex: 0, emoji: '🇮🇳' },
        { question: 'Which country is this? 🇺🇸', options: ['UK', 'Canada', 'USA', 'Australia'], correctIndex: 2, emoji: '🇺🇸' },
        { question: 'Which country is this? 🇯🇵', options: ['China', 'Japan', 'Korea', 'Thailand'], correctIndex: 1, emoji: '🇯🇵' },
        { question: 'Which country is this? 🇬🇧', options: ['France', 'Germany', 'Italy', 'UK'], correctIndex: 3, emoji: '🇬🇧' },
        { question: 'Which country is this? 🇫🇷', options: ['France', 'Spain', 'Portugal', 'Belgium'], correctIndex: 0, emoji: '🇫🇷' },
        { question: 'Which country is this? 🇧🇷', options: ['Argentina', 'Brazil', 'Chile', 'Peru'], correctIndex: 1, emoji: '🇧🇷' },
        { question: 'Which country is this? 🇦🇺', options: ['New Zealand', 'Australia', 'Fiji', 'Papua'], correctIndex: 1, emoji: '🇦🇺' },
        { question: 'Which country is this? 🇩🇪', options: ['Austria', 'Switzerland', 'Germany', 'Netherlands'], correctIndex: 2, emoji: '🇩🇪' },
        { question: 'Which country is this? 🇨🇦', options: ['USA', 'Canada', 'UK', 'Mexico'], correctIndex: 1, emoji: '🇨🇦' },
        { question: 'Which country is this? 🇮🇹', options: ['Spain', 'Greece', 'Italy', 'Portugal'], correctIndex: 2, emoji: '🇮🇹' },
        { question: 'Which country is this? 🇨🇳', options: ['Japan', 'Korea', 'China', 'Vietnam'], correctIndex: 2, emoji: '🇨🇳' },
        { question: 'Which country is this? 🇷🇺', options: ['Canada', 'USA', 'Russia', 'Norway'], correctIndex: 2, emoji: '🇷🇺' },
        { question: 'Which country is this? 🇲🇽', options: ['Spain', 'Mexico', 'Brazil', 'Argentina'], correctIndex: 1, emoji: '🇲🇽' },
        { question: 'Which country is this? 🇿🇦', options: ['Nigeria', 'Kenya', 'South Africa', 'Egypt'], correctIndex: 2, emoji: '🇿🇦' },
        { question: 'Which country is this? 🇰🇷', options: ['Japan', 'China', 'Korea', 'Thailand'], correctIndex: 2, emoji: '🇰🇷' },
        { question: 'Which country is this? 🇪🇬', options: ['Morocco', 'Egypt', 'Algeria', 'Tunisia'], correctIndex: 1, emoji: '🇪🇬' },
        { question: 'Which country is this? 🇳🇬', options: ['Kenya', 'South Africa', 'Nigeria', 'Ghana'], correctIndex: 2, emoji: '🇳🇬' },
        { question: 'Which country is this? 🇦🇷', options: ['Brazil', 'Chile', 'Argentina', 'Peru'], correctIndex: 2, emoji: '🇦🇷' },
        { question: 'Which country is this? 🇹🇷', options: ['Greece', 'Turkey', 'Iran', 'Egypt'], correctIndex: 1, emoji: '🇹🇷' },
        { question: 'Which country is this? 🇹🇭', options: ['Vietnam', 'Thailand', 'Cambodia', 'Laos'], correctIndex: 1, emoji: '🇹🇭' },
        { question: 'Which country is this? 🇳🇿', options: ['Australia', 'New Zealand', 'Fiji', 'Papua'], correctIndex: 1, emoji: '🇳🇿' },
        { question: 'Which country is this? 🇸🇪', options: ['Norway', 'Finland', 'Sweden', 'Denmark'], correctIndex: 2, emoji: '🇸🇪' },
        { question: 'Which country is this? 🇬🇷', options: ['Italy', 'Greece', 'Spain', 'Turkey'], correctIndex: 1, emoji: '🇬🇷' },
        { question: 'Which country is this? 🇨🇭', options: ['Austria', 'Germany', 'Switzerland', 'France'], correctIndex: 2, emoji: '🇨🇭' },
        { question: 'Which country is this? 🇮🇩', options: ['Malaysia', 'Philippines', 'Indonesia', 'Thailand'], correctIndex: 2, emoji: '🇮🇩' }
      ];
      return <QuizTemplate questions={qs} title="🏳️ Country Flags" pageSize={5} />;
    }
